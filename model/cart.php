<?php
    ...
    function insert_cart($id_user,$id_pro,$img,$name,$price,$quality,$id_bill){
        $sql="INSERT INTO `cart` (`id_user`,`id_pro`,`img`,`name`,price,`quality`,`id_bill`) VALUES ('$id_user','$id_pro','$img','$name','$price','$quality','$id_bill')";
